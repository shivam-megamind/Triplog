...
export function createClientRequestId(cryptoApi: CompatibleCrypto | null | undefined = globalThis.crypto): string {
  ...
  if (typeof cryptoApi?.getRandomValues === "function") {
    try {
      ...
      // Continue to the non-cryptographic request-ID fallback below.
    }
  }
